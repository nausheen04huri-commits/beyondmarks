...
async function addStudent(event) {
    ...
    try {
        const response = await fetch("https://beyondmarks-1.onrender.com/api/students", {
            method: "POST",
            headers: {
...
async function loadAcademics() {
    ...
    try {
        ...
        const response = await fetch("https://beyondmarks-1.onrender.com/api/academics");
...
async function loadActivities() {
    ...
    try {
        ...
        const response = await fetch("https://beyondmarks-1.onrender.com/api/activities");
...
async function loadSkills() {
    ...
    try {
        ...
        const response = await fetch("https://beyondmarks-1.onrender.com/api/skills");
...
async function loadAchievements() {
    ...
    try {
        ...
        const response = await fetch("https://beyondmarks-1.onrender.com/api/achievements");
